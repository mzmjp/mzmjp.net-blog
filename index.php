...
<?php the_content(); ?>
			...
			<footer class="mod-entry-footer">
				<?php the_tags('<ul class="mod-entry-tags">Tags : <li class="mod-entry-tagname"><span class="icon-tag" aria-hidden="true"></span>','</li><li class="mod-entry-tagname"><span class="icon-tag" aria-hidden="true"></span>','</li></ul>');?>
